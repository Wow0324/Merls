        ...
        <section class="heading bcblack bdr9 white mb30">
            <div class="row align-items-center justify-content-between">
                <div class="col-sm-9 d-flex align-items-center">
                    <h1 class="fs32 mb0 ml20">{{$activeProperty != null ? $activeProperty->name : 'No property selected'}}</h1>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="inner">
                        <div class="row  align-items-center">
                            <div class="col-sm-9">
                                <div class="{{$activeProperty && $activeProperty->approved == 1 ? 'satatus-approved' : ''}} fs24 lh1-2">
                                    <b class="block">Status</b>
                                    <span class="{{$activeProperty && $activeProperty->approved == 1 ? 'green' : 'red'}}">
                                        @if ($activeProperty != null)
                                            {{$activeProperty->approved == 0 ? 'Pending' : ( $activeProperty->approved == 1 ? 'Approved' : 'Denied')}}
                                        @else
                                            No selected
                                        @endif
                                    </span>
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-10">
                                <div class="jurisdiction fs24 lh1-2">
                                    ...
                                    <span id="jurisdiction-value" class="{{$activeProperty && $activeProperty->jurisdiction != '' ? 'gray' : 'red'}}">
                                        @if ($activeProperty != null)
                                            {{$activeProperty->jurisdiction != '' ? $activeProperty->jurisdiction : 'Not Added'}}
                                        @else
                                            No selected
                                        @endif
                                    </span>
                            ...
                            <div class="col-sm-2 text-right">
                                <a href="#property-jurisdiction-dialog" class="edit-user fancybox-inline" onclick="showEditJurisdictionLayout()">
