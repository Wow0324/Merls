            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-4 text-right">
                    @guest
                        ...
                        @endif
                    @else
                        @if (Str::contains(request()->url(), 'property'))
                        ...
                        @if (!Str::contains(request()->url(), 'signup'))
                            <a href="#profile" class="menu fancybox-inline ml40" onclick="initProfileErrorValidation()"><img src="{{asset('img/user-icon.png')}}"></a>
                        @endif
                    @endguest
